...
LLVM.CFLAGS=	-g -disable-pass=-codegenprepare -disable-pass=-inline
LLVM.LDFLAGS=	-Wllld,-L/usr/lib/bca -Wo-start -load=libLLVMFaultInjector.so -edfi ${LLVM_PASS_ARGS} -Wo-end
